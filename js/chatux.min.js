/*! chatux v1.1.0 Copyright (c) 2019 Tom Misawa, riversun.org@gmail.com, https://github.com/riversun */ ! function(t, e) {
  ...
  return function(t) {
      ...
      return n = {}, t.m = e = [function(t, e, n) {
        ...
        n(10), t.exports.getStyle = function(t) {
          return t.showTitleBar = !0, t.showCloseButton = !0, t.titleBarCaptionFontSize = "11px", t.titleBarCaptionFontWeight = "normal", t.titleBarCaptionLeftMargin = null, t.titleBarCaptionColorDefault = "#4d494d", t.titleBarCaptionColorFocused = "#4d494d", t.titleBarHeight = "26px", t.titleBarColorDefault = "#f4f4f4", t.titleBarColorFocused = "#f4f4f4", t.titleBarBorderBottomDefault = "1px solid #b1aeb1", t.titleBarBorderBottomFocused = t.titleBarBorderBottomDefault, t.frameBorderRadius = "6px", t.frameBorderWidthDefault = "1px", t.frameBorderWidthFocused = "1px", t.frameBorderColorDefault = "#acacac", t.frameBorderColorFocused = "#acacac", t.frameBorderStyle = "solid", t.frameBoxShadow = "0px 0px 20px rgba(0, 0, 0, 0.3)", t.frameBackgroundColor = "transparent", t.frameComponents = new Array, t.getTitleBarStyle = function() {
            ...
            var e = t.getPartsBuilder(),
              n = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAADxJREFUeNpiYEACyhKiU0AYWYyJARX4QDFOBRiAEWokTJc0lH4KpbcQNIEBzZEPQJgkN7Cg8begKwAIMAC1EQhm4CX95QAAAABJRU5ErkJggg==",
            ...
            s.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAAICAYAAADED76LAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAAFdJREFUeNpi/P//PwNeAFKgLCF6AIjnwMRAbJAYSI4FKnYHiJOBgjA1yUA8F24Ckq7/UDwHJsfEQACwwHSjGIuwLgXmBhWQ5N0Xr1OgGmBiDIyEvAkQYAB60iRIRtfWzQAAAABJRU5ErkJggg==", s.setAttribute("style", r);
        ...
        function v(t) {
          ...
          if (t && 0 == t.fixed && (r = !1), t && t.parentElement && (n = t.parentElement), e.hAlign = "left", e.vAlign = "top", t && t.horizontalAlign && (e.hAlign = t.horizontalAlign), t && t.verticalAlign && (e.vAlign = t.verticalAlign), !n && r) {
            ...
            o.id = "jsFrame_fixed_" + e.generateUUID(), o.setAttribute("style", "position:fixed;" + e.hAlign + ":0px;" + e.vAlign + ":0px;margin:0px;padding:0px;"), document.body.appendChild(o), n = o
    ...
    e.definition = {
      prefix: "fas",
      iconName: "times",
      icon: [352, 512, r, "f00d", o]
    }, e.faTimes = e.definition, e.prefix = "fas", e.iconName = "times", e.width = 352, e.height = 512, e.ligatures = r, e.unicode = "f00d", e.svgPathData = o
  }, function(t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", {
      value: !0
    ...
    var r = [],
      o = "M448 0H64C28.7 0 0 28.7 0 64v288c0 35.3 28.7 64 64 64h96v84c0 9.8 11.2 15.5 19.1 9.7L304 416h144c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64z";
    e.definition = {
      prefix: "fas",
      iconName: "comment-alt",
      icon: [512, 512, r, "f27a", o]
    }, e.faCommentAlt = e.definition, e.prefix = "fas", e.iconName = "comment-alt", e.width = 512, e.height = 512, e.ligatures = r, e.unicode = "f27a", e.svgPathData = o
  }, function(t, e, n) {
    /*!
     * Vue.js v2.0.5
        ...
        return n.BotUI = function(t, e) {
          return function(e, n) {
            ...
            function a(t) {
              ...
              t.type = t.type || "text", t.visible = !t.delay && !t.loading, t.human && p.opt.humanPhoto && (t.humanPhoto = p.opt.humanPhoto), !t.human && p.opt.botPhoto && (t.botPhoto = p.opt.botPhoto), t.afterUpdate = !1;
            ...
            return p.message = {
              ...
              update: function(t, e) {
                var n = g.messages[t];
                return n.content = e.content, n.visible = !e.loading, n.loading = !!e.loading, n.afterUpdate = !0, Promise.resolve(e.content)
              },
              removeAll: function() {
            ...
            }, f.fontawesome && o("fontAwesome.js"), f.searchselect && o("vue-select.js", function() {
      ...
      return e = t, (n = [{
        ...
        value: function() {
          ...
          this.buttonState ? this.buttonState === this.BUTTON_STATE_OPEN ? (this.buttonState = this.BUTTON_STATE_TRANSITION, this.show(function() {
            t.buttonOffWhenOpenFrame && "pc" === t.renderMode ? t.setChatButtonVisible(!1) : e.innerHTML = t.ICON_CROSSMARK, t.buttonState = t.BUTTON_STATE_CLOSE
          })) : this.buttonState === this.BUTTON_STATE_TRANSITION || (this.buttonState = this.BUTTON_STATE_TRANSITION, this.hide(function() {
            t.buttonOffWhenOpenFrame && "pc" === t.renderMode ? t.setChatButtonVisible(!0) : e.innerHTML = t.ICON_COMMENT, t.buttonState = t.BUTTON_STATE_OPEN
        ...
        key: "buildChatArea",
        value: function() {
          this.chatAreaEle = document.createElement("div#ChatArea"), document.body.appendChild(this.chatAreaEle), this.initializeChatArea()
        }
      }, {
